...
ParticleEmitter::ParticleEmitter(void) {
	...
	*/
	...
	particleTexture = SOIL_load_OGL_texture(TEXTUREDIR"Snow.png", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_COMPRESS_TO_DXT);
}
...
Particle* ParticleEmitter::GetFreeParticle() {
	...
	p->position = Vector3(100.0f, 100.0f, 100.0f);  //position
